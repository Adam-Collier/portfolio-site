...
tags:
  - Gatsby
  - Markdown
excerpt: Show when your content has been updated for better SEO
description: >-
...
updatedDate: '2021-02-17T18:19:31.257Z'
---
...
The approach that Lee Robinson and Michael Novotny took is to have an existing meta-object in the MDX which is altered via a script. It's a great idea but I want to cater to both Markdown and MDX files but also edit files which don't contain the initial object. Therefore, instead of having a meta-object, which would only be usable in MDX documents, we parse and alter the frontmatter instead. This way we have a common solution which easily integrates into Next and Gatsby projects.
